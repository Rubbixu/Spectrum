		 ...
		 <p>PRISM represents a spectrum of services that provide continuous support for organizations and companies to empower people with the skills that are needed to succeed in life.</p>
		  ...
		  <div class="ab-w3-agile-inner">
	       <div class="col-md-6 ab-w3-agile-part">
		     	<h4>Spectrum</h4>
		     <p>An online tutorial.</p>
		     <p>Used to train the undergraduate</p>
		     <p>teacher how to educate students</p>
	       </div>
			<div class="col-md-6 ab-w3-agile-part two">
				<h4>Students</h4>
		     <p>Boning Liang, Muzi Li and Chang</p>
		     <p>Ren, master students in</p>
			...
			<div class="gallery-grids carouselGallery-grid hidden-xs">
				...
				<div class="col-md-4 gallery-grid">
					<div class="carouselGallery-col-1 carouselGallery-carousel" data-likes="3144" data-index="1" data-username=" " data-imagetext="The teacher does not know how to handle the student who has oppositional defiant disorder. In this case, the teacher does not pay much attention to Willy. When Willy's behavior problems appear, the teacher doesn't know how to help Willy and solve the problem by herself. She instead sends him to the positive behavior teacher to correct his behavior. For this scenario, I would like for teachers to be aware of this kind of situation and be encouraged to learn this disorder."
						data-location="Case Study 10" data-imagepath="images/g5.jpg" data-posturl="#"
			...
			<div class="agile-contact">
				...
				<div class="con-bot">
					<div class="left-bw3">
						...
						<p>Auburn University, Alabama, USA 36849</p>
