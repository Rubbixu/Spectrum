...
<div id="pageWrap">
  <div id="headerWrap">
    <div id="header" >
      ...
      <div id="headerTitle">
        <div class="titleArea" style="position: absolute;right: 0px;top:40px">
		...
		<table class="nav">
		    <td width="600"></td>
            <td style="font-style:italic;width:150;text-align:right;font-size:14px; color:#FFFFFF;text-transform:none" >
              <?php
