...
<html>
<head>
<title>Discussions---My Question Details</title>
...
<div id="pageWrap"> 
  ...
  <div id="contentArea">
    ...
    <div class="contentDivision" style="left: 0px; top: 0px;">
      ...
      <?php
      echo '<form name="myQues_details" action="./quesEdit.php?quesId='.$quesId.'" method="POST">';
      ?>
        ...
        <table style="width:800px; border="0">
          ...
          if ($resultCheck > 0)
          {
            while($row = mysqli_fetch_assoc($result))
            {
              ...
              $result = mysqli_query($conn, $sql);
              while($findUser = mysqli_fetch_assoc($result))
              {
                $answererName = $findUser["userDisplayName"];
              }

              echo "<tr>";
              echo "<td width='100' align='right'>".$answererName." : </td>";
          ...
          <tr>
            ...
            <td>
              <input type="submit" name="editQues" value="Edit Question" onMouseOver="this.style.cursor='hand'" style="width:100px; height:30px;">
            </td>
          </tr>
        </table>
      </center>
