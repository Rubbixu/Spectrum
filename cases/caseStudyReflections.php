...
<div id="pageWrap">
  <div id="headerWrap">
    <div id="header">
      ...
      <div id="headerTitle">
		...
		<table class="nav">
      <td width="600"></td>
        <td style="font-style:italic;width:150;text-align:right;font-size:14px; color:#FFFFFF; padding-top:5px;text-transform:none;">
          <?php
  ...
  <div id="contentArea">
    ...
    echo '<h4><a href="./caseStudyReflections.php?caseID='.$caseID.'" target="_self" title="caseStudy_'.$caseID.'_2">Casestudy '.$caseID.': Reflections</a></h4>';
    ...
    <div class="contentDivision">
      <p class="breadcrumb"><a href="./caseIndex.php">Case Select</a>  &gt;Case study <?php echo $caseID; ?> <!-- TemplateEndEditable -->
      </p>
        ...
        for ($i = 0; $i < count($quesIdList); $i++)
        {
          ...
          if ($resultCheck > 0)
          {
            while($row = mysqli_fetch_assoc($result))
            {
              ...
              array_push($optionIDList, $optionID);
              array_push($optionContentList, $optionContent);
            }
          }
          ...
          {
            echo '<input name="optForQ'.$quesIdList[$i].'" type="radio" value="'.$optionIDList[$j].'">'.$optionContentList[$j];
            echo '<br>';
          }
      ...
      echo '<tr>&emsp;&emsp;<input type="submit" value="Check Answer" onClick="javascript:window.location.href=\'./caseStudyAnswers.php?caseID='.$caseID.'\';"></tr>';
      echo '<tr>&nbsp;&nbsp;&nbsp;</tr>';
      echo '<tr> <input type="submit" value="Back to Video" onClick="javascript:window.location.href=\'./caseStudy.php?caseID='.$caseID.'\';"></tr>';
      ?>
