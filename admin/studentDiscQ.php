...
<div id="pageWrap"> 
    	...
    	<div id="contentArea">
          ...
          <p class="breadcrumb"><a href="./studentDisc.php">Discussinons</a> &gt; Topics</p> 
			<table class="hover" id="example" style="width:100%;font-family:Georgia;text-align: center">
      <caption style="text-align: center;color:#000000;font-weight: bold;font-size:18px;">Topic List</caption>
			<tbody>
				<?php
